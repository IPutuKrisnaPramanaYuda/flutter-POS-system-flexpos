  ...
  ThemeData _buildLightTheme() {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme().copyWith(
        ...
        headlineMedium: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textDark),
        headlineSmall: GoogleFonts.inter(fontSize: 17, fontWeight: FontWeight.bold, color: AppColors.textDark),
        titleLarge: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w600, color: AppColors.textDark),
        titleMedium: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.textDark),
        ...
        labelMedium: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w600),
      ),
  ...
  ThemeData _buildDarkTheme() {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme(ThemeData.dark().textTheme).copyWith(
        ...
        headlineSmall: GoogleFonts.inter(fontSize: 17, fontWeight: FontWeight.bold, color: Colors.white),
        titleLarge: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white),
        titleMedium: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.white),
        ...
        labelMedium: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white),
      ),
      appBarTheme: AppBarTheme(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: Colors.white.withAlpha(30))),
